            ...
            {invitesLoading ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="rounded-2xl border border-gold/10 bg-card p-6 space-y-4"
                  >
              ...
              <div className="flex flex-col items-center justify-center py-24 text-center">
                ...
                <p className="font-raleway text-foreground/50 text-sm max-w-sm mb-8">
                  Create your first beautiful wedding invitation and share it
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden px-4">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 20% 50%, oklch(0.75 0.15 60) 0%, transparent 50%), radial-gradient(circle at 80% 20%, oklch(0.65 0.18 30) 0%, transparent 50%)",
          }}
        />
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <p className="font-raleway text-base sm:text-lg text-foreground/50 max-w-2xl mx-auto mb-10 leading-relaxed">
            Craft breathtaking digital wedding invitations inspired by India's
            rich cultural heritage. Share your love story with elegance and
            grace.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.step} className="text-center group">
                ...
                <div className="font-cinzel text-xs text-gold/40 tracking-widest mb-2">
                  {item.step}
                </div>
                <h3 className="font-cinzel text-lg font-semibold text-foreground/80 mb-2">
                  {item.title}
                </h3>
                <p className="font-raleway text-sm text-foreground/50 leading-relaxed">
                  {item.desc}
                </p>
              </div>
            ))}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
            {TEMPLATES.map((template) => (
              <button
                ...
                key={template.id}
                onClick={handleCreateNew}
                className="group cursor-pointer rounded-xl overflow-hidden border border-gold/10 hover:border-gold/30 transition-all duration-300 hover:shadow-lg hover:shadow-gold/10 text-left"
              >
