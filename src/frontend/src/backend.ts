...
import type { CreateInviteResult as _CreateInviteResult, ExternalBlob as _ExternalBlob, InvitePayload as _InvitePayload, InviteRecord as _InviteRecord, RSVPRecord as _RSVPRecord, ScheduleItem as _ScheduleItem, SectionConfig as _SectionConfig, UpdateInviteResult as _UpdateInviteResult, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createInvite(arg0: string, arg1: InvitePayload): Promise<CreateInviteResult> {
        if (this.processError) {
            try {
                const result = await this.actor.createInvite(arg0, await to_candid_InvitePayload_n10(this._uploadFile, this._downloadFile, arg1));
                return from_candid_CreateInviteResult_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getInviteCreator(arg0: string): Promise<Principal | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getInviteCreator(arg0);
    ...
    async getMyInvites(): Promise<Array<InviteRecord>> {
        if (this.processError) {
            try {
    ...
    async getRSVPResponses(arg0: string): Promise<Array<RSVPRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRSVPResponses(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitInviteRSVP(arg0: string, arg1: RSVPRecord): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInviteRSVP(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateInvite(arg0: string, arg1: InvitePayload): Promise<UpdateInviteResult> {
        if (this.processError) {
            try {
                const result = await this.actor.updateInvite(arg0, await to_candid_InvitePayload_n10(this._uploadFile, this._downloadFile, arg1));
                return from_candid_UpdateInviteResult_n26(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_CreateInviteResult_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CreateInviteResult): CreateInviteResult {
...
async function from_candid_InviteRecord_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _InviteRecord): Promise<InviteRecord> {
    return await from_candid_record_n21(_uploadFile, _downloadFile, value);
}
function from_candid_UpdateInviteResult_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _UpdateInviteResult): UpdateInviteResult {
...
async function from_candid_opt_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_InviteRecord]): Promise<InviteRecord | null> {
    return value.length === 0 ? null : await from_candid_InviteRecord_n20(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        galleryImages: await from_candid_vec_n22(_uploadFile, _downloadFile, value.galleryImages),
        weddingDate: value.weddingDate,
        groomPhoto: await from_candid_ExternalBlob_n23(_uploadFile, _downloadFile, value.groomPhoto),
        ...
        coverPhoto: await from_candid_ExternalBlob_n23(_uploadFile, _downloadFile, value.coverPhoto),
        events: value.events,
        ...
        bridePhoto: await from_candid_ExternalBlob_n23(_uploadFile, _downloadFile, value.bridePhoto)
    };
}
...
async function from_candid_vec_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_InviteRecord>): Promise<Array<InviteRecord>> {
    return await Promise.all(value.map(async (x)=>await from_candid_InviteRecord_n20(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_InvitePayload_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: InvitePayload): Promise<_InvitePayload> {
...
async function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        weddingDate: value.weddingDate,
        groomPhoto: await to_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.groomPhoto),
        themeVariant: value.themeVariant,
        templateId: value.templateId,
        customTextFields: value.customTextFields,
        sectionsConfig: value.sectionsConfig,
        coverPhoto: await to_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.coverPhoto),
        events: value.events,
        coupleNames: value.coupleNames,
        backgroundMusic: value.backgroundMusic,
        bridePhoto: await to_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.bridePhoto)
    };
}
