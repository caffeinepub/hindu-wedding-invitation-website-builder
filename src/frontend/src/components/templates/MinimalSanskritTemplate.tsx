...
export default function MinimalSanskritTemplate({
  invite,
  variant = "light",
}: TemplateProps) {
  ...
  const heroStyle: React.CSSProperties = isDark
    ...
    : {
        background: "#FAF3E0",
        backgroundImage:
          "radial-gradient(ellipse at 50% 50%, rgba(212,175,55,0.12) 0%, transparent 70%)",
      };
  ...
  return (
    <BaseTemplate
      ...
      rsvpBackground={
        isDark ? "rgba(26, 21, 16, 0.95)" : "rgba(245, 238, 220, 0.97)"
      }
    >
      ...
      >
        ...
        <svg
          viewBox="0 0 300 300"
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 opacity-8"
          aria-hidden="true"
        >
          <text
            x="150"
        ...
        >
          ...
          {[
            ...
            <g key={`top-lotus-${cx}`} transform={`translate(${cx}, 20)`}>
              <ellipse
                cx="0"
                cy="-6"
                rx="4"
        ...
        >
          ...
          {[
            ...
            <g key={`bot-lotus-${cx}`} transform={`translate(${cx}, 20)`}>
              <ellipse
                cx="0"
                cy="-6"
                rx="4"
        ...
        <svg
          viewBox="0 0 40 300"
          className="absolute top-1/2 left-4 -translate-y-1/2 w-8 h-64 opacity-20"
          aria-hidden="true"
        >
          <line
            x1="20"
          ...
          {[50, 100, 150, 200, 250].map((y) => (
            <g key={`left-div-${y}`} transform={`translate(20, ${y})`}>
              <ellipse
                cx="0"
                cy="-8"
                rx="5"
        ...
        <svg
          viewBox="0 0 40 300"
          className="absolute top-1/2 right-4 -translate-y-1/2 w-8 h-64 opacity-20"
        ...
        >
          ...
          />
          {[50, 100, 150, 200, 250].map((y) => (
            <g key={`right-div-${y}`} transform={`translate(20, ${y})`}>
              <ellipse
                cx="0"
                cy="-8"
                rx="5"
