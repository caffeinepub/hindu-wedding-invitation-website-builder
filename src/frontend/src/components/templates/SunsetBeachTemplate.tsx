...
export default function SunsetBeachTemplate({
  invite,
  variant = "light",
}: TemplateProps) {
  ...
  const heroStyle: React.CSSProperties = isDark
    ? {
        background:
          "linear-gradient(160deg, #1a0a00 0%, #3d1500 50%, #1a0a00 100%)",
      }
    : {
        background:
          "linear-gradient(160deg, #FF6B35 0%, #F7C59F 40%, #FFBE0B 70%, #FF6B35 100%)",
      };
  ...
  return (
    <BaseTemplate
      ...
      rsvpBackground={
        isDark ? "rgba(120, 50, 20, 0.92)" : "rgba(120, 50, 20, 0.88)"
      }
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 55% at 50% 60%, rgba(255,190,11,0.12) 0%, rgba(255,107,53,0.18) 50%, rgba(0,0,0,0.40) 100%)",
          }}
        />
        ...
        <svg
          viewBox="0 0 400 400"
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 opacity-12"
          aria-hidden="true"
        >
            ...
            {[
              ...
              return (
                <line
                  ...
                  stroke={amber}
                  strokeWidth={deg % 60 === 0 ? 2 : 1}
                  opacity={deg % 60 === 0 ? 0.7 : 0.4}
                />
              );
            })}
        ...
        >
          ...
          <path
            d="M0,25 Q40,5 80,25 Q120,45 160,25 Q200,5 240,25 Q280,45 320,25 Q360,5 400,25 Q440,45 480,25 Q520,5 560,25 Q600,45 640,25 Q680,5 720,25 Q760,45 800,25"
            fill="none"
            stroke="url(#sb-wave)"
            strokeWidth="2.5"
          />
          <path
            d="M0,35 Q40,15 80,35 Q120,50 160,35 Q200,15 240,35 Q280,50 320,35 Q360,15 400,35 Q440,50 480,35 Q520,15 560,35 Q600,50 640,35 Q680,15 720,35 Q760,50 800,35"
            fill="none"
            stroke="url(#sb-wave)"
            strokeWidth="1.2"
            opacity="0.5"
        ...
        <svg
          viewBox="0 0 100 400"
          className="absolute top-0 left-0 h-full w-20 opacity-20"
          preserveAspectRatio="none"
          aria-hidden="true"
        >
          {/* Palm fronds */}
          <path
            d="M10,400 Q20,300 5,200 Q-5,150 15,80"
            fill="none"
            stroke={teal}
            strokeWidth="2"
          />
          <path
            d="M15,80 Q40,40 80,20"
            fill="none"
            stroke={teal}
            strokeWidth="1.5"
          />
          <path
            d="M15,80 Q-10,50 5,10"
            fill="none"
            stroke={teal}
            strokeWidth="1.5"
          />
          <path
            d="M15,80 Q50,70 90,90"
            fill="none"
            stroke={teal}
            strokeWidth="1.2"
          />
          <path
            d="M5,200 Q30,180 60,190"
            fill="none"
            stroke={teal}
            strokeWidth="1.2"
          />
          <path
            d="M5,200 Q-15,220 10,250"
            fill="none"
            stroke={teal}
            strokeWidth="1"
          />
          ...
          {[280, 320, 360, 400].map((y, i) => (
            <path
              key={`left-grass-${y}`}
              d={`M${10 + i * 3},${y} Q${20 + i * 2},${y - 30} ${15 + i * 4},${y - 60}`}
              fill="none"
              stroke={teal}
              strokeWidth="1"
              opacity="0.7"
        ...
        <svg
          viewBox="0 0 100 400"
          className="absolute top-0 right-0 h-full w-20 opacity-20"
          preserveAspectRatio="none"
