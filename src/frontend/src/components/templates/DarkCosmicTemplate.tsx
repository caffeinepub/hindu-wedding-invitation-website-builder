...
export default function DarkCosmicTemplate({
  invite,
  variant = "light",
}: TemplateProps) {
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(123,104,238,0.12) 0%, rgba(212,175,55,0.06) 40%, transparent 70%)",
          }}
        />
        ...
        <svg
          viewBox="0 0 600 600"
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] opacity-12"
          aria-hidden="true"
        >
            ...
            {[240, 200, 160].map((r) =>
              [0, 60, 120, 180, 240, 300].map((deg) => (
                <circle
                  ...
                  cy={r * 0.35 * Math.sin((deg * Math.PI) / 180)}
                  r="2.5"
                  fill={gold}
                  opacity="0.5"
                />
        ...
        >
          ...
          {[
            ...
            248, 264, 280, 296, 312, 328, 344, 360, 376, 392, 408, 424, 440,
            456, 472, 488, 504, 520, 536, 552, 568, 584, 600, 616, 632, 648,
            664, 680, 696, 712, 728, 744, 760, 776, 792,
          ].map((cx, i) => (
            <circle
              key={`bdot-${cx}`}
              cx={cx}
