...
export default function SouthIndianBronzeTemplate({
  invite,
  variant = "light",
}: TemplateProps) {
  ...
  const heroStyle: React.CSSProperties = isDark
    ? {
        background:
          "linear-gradient(160deg, #1a0e00 0%, #3d2200 50%, #1a0e00 100%)",
      }
    : {
        background:
          "linear-gradient(160deg, #8B5E3C 0%, #CD853F 50%, #8B5E3C 100%)",
      };
  ...
  return (
    <BaseTemplate
      ...
      rsvpBackground={
        isDark ? "rgba(60, 30, 10, 0.93)" : "rgba(60, 30, 10, 0.90)"
      }
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 60% at 50% 40%, rgba(205,133,63,0.15) 0%, rgba(139,94,60,0.25) 55%, rgba(0,0,0,0.50) 100%)",
          }}
        />
        ...
        <svg
          viewBox="0 0 120 120"
          className="absolute top-0 left-0 w-28 h-28 opacity-25"
          aria-hidden="true"
        >
          <g transform="translate(10,10)">
            ...
            {/* Kolam curves */}
            <path
              d="M10,10 Q50,-10 90,10 Q110,50 90,90 Q50,110 10,90 Q-10,50 10,10 Z"
              fill="none"
              stroke={bronze}
              strokeWidth="1.2"
              opacity="0.7"
        ...
        <svg
          viewBox="0 0 120 120"
          className="absolute top-0 right-0 w-28 h-28 opacity-25"
        ...
        >
          ...
          {[
            ...
            <g key={`top-kolam-${cx}`} transform={`translate(${cx}, 18)`}>
              <path
                d="M0,-5 Q5,0 0,5 Q-5,0 0,-5 Z"
                fill="none"
                stroke={gold}
                strokeWidth="0.8"
                opacity="0.7"
        ...
        >
          ...
          {[
            ...
            <g key={`bot-kolam-${cx}`} transform={`translate(${cx}, 18)`}>
              <path
                d="M0,-5 Q5,0 0,5 Q-5,0 0,-5 Z"
                fill="none"
                stroke={gold}
