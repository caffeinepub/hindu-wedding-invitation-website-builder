...
export default function RoyalRajasthaniTemplate({
  invite,
  variant = "light",
}: TemplateProps) {
  ...
  const heroStyle: React.CSSProperties = isDark
    ? {
        background:
          "linear-gradient(160deg, #1a0005 0%, #3d0010 40%, #1a0005 100%)",
      }
    : {
        background:
          "linear-gradient(160deg, #7a0020 0%, #c0392b 40%, #8b0000 100%)",
      };
  ...
  return (
    <BaseTemplate
      ...
      rsvpBackground={
        isDark ? "rgba(80, 10, 20, 0.92)" : "rgba(80, 10, 20, 0.88)"
      }
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(212,175,55,0.08) 0%, rgba(139,0,0,0.25) 60%, rgba(0,0,0,0.55) 100%)",
          }}
        />
        ...
        <svg
          viewBox="0 0 240 240"
          className="absolute top-0 left-0 w-56 h-56 opacity-20"
          aria-hidden="true"
        >
          <defs>
            <pattern
        ...
        <svg
          viewBox="0 0 160 200"
          className="absolute top-4 right-4 w-36 h-44 opacity-25"
          aria-hidden="true"
        >
          <g transform="translate(80,100)">
            {[0, 72, 144, 216, 288].map((angle) => (
              <g key={`paisley-tr-${angle}`} transform={`rotate(${angle})`}>
                <path
                  d="M0,-60 C20,-55 30,-35 20,-15 C10,5 -10,10 -15,0 C-20,-10 -10,-25 0,-60 Z"
                  fill="none"
                  stroke={gold}
                  strokeWidth="1.2"
                  opacity="0.8"
                />
                <path
                  d="M0,-60 C15,-50 22,-32 14,-14 C8,0 -6,6 -10,0"
                  fill="none"
                  stroke={gold}
                  strokeWidth="0.6"
                  opacity="0.5"
        ...
        <svg
          viewBox="0 0 160 200"
          className="absolute bottom-4 left-4 w-36 h-44 opacity-25"
          aria-hidden="true"
        >
          <g transform="translate(80,100) rotate(180)">
            {[0, 72, 144, 216, 288].map((angle) => (
              <g key={`paisley-bl-${angle}`} transform={`rotate(${angle})`}>
                <path
                  d="M0,-60 C20,-55 30,-35 20,-15 C10,5 -10,10 -15,0 C-20,-10 -10,-25 0,-60 Z"
                  fill="none"
                  stroke={gold}
        ...
        >
          ...
          {[
            ...
            <g key={`top-chevron-${cx}`} transform={`translate(${cx}, 12)`}>
              <polygon
        ...
        >
          ...
          {[
            ...
            <g key={`bot-chevron-${cx}`} transform={`translate(${cx}, 12)`}>
              <polygon
                points="10,0 20,8 10,16 0,8"
                fill="none"
                stroke={gold}
        ...
        <svg
          viewBox="0 0 400 500"
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-96 opacity-10"
          aria-hidden="true"
        >
          <path
            d="M60,480 L60,200 Q60,40 200,40 Q340,40 340,200 L340,480"
            fill="none"
            stroke={gold}
            strokeWidth="2"
          />
          <path
            d="M80,480 L80,210 Q80,70 200,70 Q320,70 320,210 L320,480"
            fill="none"
            stroke={gold}
            strokeWidth="1"
            opacity="0.5"
