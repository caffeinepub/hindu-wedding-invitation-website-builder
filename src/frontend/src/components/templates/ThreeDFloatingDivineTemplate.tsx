...
export default function ThreeDFloatingDivineTemplate({
  invite,
  variant = "light",
}: TemplateProps) {
  ...
  const heroStyle: React.CSSProperties = isDark
    ? {
        background:
          "radial-gradient(ellipse at center, #1a0a3e 0%, #0d0020 100%)",
        backgroundImage:
          "radial-gradient(ellipse at 30% 40%, rgba(123,104,238,0.15) 0%, transparent 50%), radial-gradient(ellipse at 70% 60%, rgba(212,175,55,0.12) 0%, transparent 50%)",
      }
    : {
        background:
          "radial-gradient(ellipse at center, #3B1F6E 0%, #1a0a3e 100%)",
        backgroundImage:
          "radial-gradient(ellipse at 30% 40%, rgba(212,175,55,0.18) 0%, transparent 50%), radial-gradient(ellipse at 70% 60%, rgba(123,104,238,0.18) 0%, transparent 50%)",
      };
  ...
  return (
    <BaseTemplate
      ...
      rsvpBackground={
        isDark ? "rgba(30, 5, 60, 0.95)" : "rgba(30, 5, 60, 0.92)"
      }
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 65% 55% at 50% 50%, rgba(123,104,238,0.15) 0%, rgba(212,175,55,0.08) 45%, rgba(0,0,0,0.60) 100%)",
          }}
        />
        ...
        <svg
          viewBox="0 0 500 500"
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[460px] h-[460px] opacity-15"
          aria-hidden="true"
        >
          <g transform="translate(250,250)">
            ...
            {[
              ...
              <line
                ...
                x1="0"
                y1="0"
                x2={Math.cos((deg * Math.PI) / 180) * 220}
                y2={Math.sin((deg * Math.PI) / 180) * 220}
                stroke={gold}
                strokeWidth="0.5"
                opacity="0.2"
              />
        ...
        <svg
          ...
          style={{
            transform: "translate(-50%, -50%) scale(0.75) translateY(-20px)",
          }}
          aria-hidden="true"
        >
        ...
        >
          ...
          {[
            ...
            464, 496, 528, 560, 592, 624, 656, 688, 720, 752, 784,
          ].map((cx) => (
            <g key={`fd-border-${cx}`} transform={`translate(${cx}, 18)`}>
              <path
