  ...
  return (
    ...
    >
      <div className="aspect-[3/2] overflow-hidden bg-deepMaroon/50">
        <img
          src={
            template?.thumb || "/assets/generated/og-fallback.dim_1200x630.png"
          }
      ...
      <div className="p-4 bg-gradient-to-b from-deepMaroon/80 to-deepMaroon">
        <p className="font-cormorant font-bold text-gold text-base">
          {template?.name || invite.templateId}
        </p>
        <p className="font-garamond text-ivory/70 text-sm mt-0.5">
          {invite.coupleNames}
        </p>
        <p className="font-garamond text-ivory/40 text-xs mt-0.5">
          {invite.weddingDate}
        </p>
      </div>
